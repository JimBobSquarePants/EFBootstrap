#region Licence
// -----------------------------------------------------------------------
// <copyright file="CodeFirstSession.cs" company="James South">
...
namespace EFBootstrap.CodeFirst
{
    ...
    /// </summary>
    public class CodeFirstSession : ISession
    {
        #region Fields
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="T:EFBootstrap.CodeFirst.CodeFirstSession"/> class. 
        /// </summary>
        ...
        public CodeFirstSession(DbContext context)
        {
        ...
        /// <summary>
        /// Finalizes an instance of the <see cref="T:EFBootstrap.CodeFirst.CodeFirstSession"/> class.
        /// </summary>
        /// <remarks>
        ...
        {
            return this.context.Set<T>().AsQueryable<T>().Where<T>(expression);
        }
        #endregion
